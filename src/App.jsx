            ...
            {projects.map((project, index) => {
              ...
              return (
                <div
                  ...
                  className="group block p-6 lg:p-8 bg-black border border-gray-800 rounded-lg transition-all duration-300 hover:border-green-400/50 hover:shadow-lg hover:shadow-green-400/10 transform hover:-translate-y-1 cursor-pointer"
                >
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex flex-wrap gap-2 mt-6">
                      {project.tech.map((tech, i) => (
                        <span
                          key={i}
                          className="text-xs px-2 sm:px-3 py-1 border border-gray-700 text-green-400 rounded-full group-hover:border-green-400/50 group-hover:text-green-400 transition-all duration-300"
                        >
                          {tech}
                        </span>
                      ))}
